...
public class Tela extends javax.swing.JFrame implements MouseListener, KeyListener {
    ...
    public Tela() {
        ...
        hHero = new Hero("Bomerman_icone-removebg-preview.png"); /* https://www.online-image-editor.com/ */
        hHero.setPosicao(0, 7);
        this.addElemento(hHero);
        
        CoronaVirus cTeste = new CoronaVirus("Monstro1_icone-removebg-preview.png");
        cTeste.setPosicao(5, 5);
        this.addElemento(cTeste);     

        CoronaVirus cCorona = new CoronaVirus("Monstro2_icone-removebg-preview.png");
        cCorona.setPosicao(3, 3);
        this.addElemento(cCorona);

        CoronaVirus cRobo = new CoronaVirus("Monstro3_icone-removebg-preview.png");
       cCorona.setPosicao(10, 5);        
        this.addElemento(cRobo);
        
        Caveira cCaveira = new Caveira("Monstro4_icone-removebg-preview.png");
...
//ADICIONAR TECLA PARA ACAO
            hHero = new Hero("Bomba_icone-removebg-preview.png");
            hHero.setPosicao(0, 7);
            this.addElemento(hHero);
